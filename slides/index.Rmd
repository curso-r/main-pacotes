...
- Vamos criar um pacote, usando a função `usethis::create_package()`. 
...
- Adicionar uma licença no pacote, com `usethis::use_***_license()`.
...
Boas práticas:
- NUNCA devemos usar o `library()` dentro de um pacote.
...
- Criar um arquivo onde iremos escrever a função para o pacote. Dica : use a função `usethis::use_r("nome_funcao")` !
