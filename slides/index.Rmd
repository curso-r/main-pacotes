...
Adapte os códigos dos arquivos a seguir, e os transforme em funções no seu pacote:

- [Exercício](https://git.io/JOcAs) - https://git.io/JOcAs

- [Desafio](https://git.io/JOcAR) - https://git.io/JOcAR
