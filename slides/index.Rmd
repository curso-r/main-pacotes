...
- Copie o código disponível em [git.io/JOL37](https://git.io/JOL37) e cole no arquivo criado.
...
```{r eval=FALSE}
mananciais <- readr::read_csv2("https://git.io/JOLeb")
...
✓ Saving 'mananciais' to 'data/mananciais.rda'
...
<!-- Troquei esse slide de lugar, mas acho que tem que ficar mais pra frente, junto com pkgdown -->
